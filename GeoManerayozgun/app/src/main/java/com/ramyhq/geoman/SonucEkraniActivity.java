...
public class SonucEkraniActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(SonucEkraniActivity.this, com.example.geoman.MainActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTekrarDene.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SonucEkraniActivity.this, com.example.geoman.OyunEkraniActivity.class));
                finish();
